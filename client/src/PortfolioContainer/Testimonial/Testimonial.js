            ...
            >
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={christo} alt="no internet connection"></img>
                    <h5>Christo Jacobs</h5>
                    <p>Manager, Autoboys Klerksdorp</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={danie} alt="no internet connection"></img>
                    <h5>Danie Bester</h5>
                    <p>Forensic Associate, PwC</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                    <img src={marie} alt="no internet connection"></img>
                    <h5>Marie-Annette Nel</h5>
                    <p>CDD Analyst, Investec</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-12">
